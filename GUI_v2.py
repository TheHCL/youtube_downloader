...
if os.path.exists(dir_path):
    ...
    del_btn = tk.Button(window,text = "delete",command=del_list_text)
    del_btn.grid(column=0,sticky=tk.W)
    del_all_btn = tk.Button(window,text = "del_all",command=del_list_all_text)
    ...
    uhd_chkbox.grid(column=0,sticky=tk.W)
    current_title = tk.Label(window)
    current_title.grid(column=0,sticky=tk.W)
